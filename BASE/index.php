...
<head>
    <!-- Required meta tags-->
    <meta charset="UTF-8">
    <link rel="icon" href="https://i.imgur.com/hyZmBRy.gif" type="image/x-icon" />
                        ...
                        <div class="login-form">
                            <form action="kernel/login.php" method="post">
                                <div class="form-group">
                                    <label>Usuário</label>
                                    <input class="au-input au-input--full" type="text" name="usuario" placeholder="Digite seu usuário">
                                </div>
                                <div class="form-group">
                                    <label>Senha</label>
